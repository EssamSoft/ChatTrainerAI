...
import { Settings, Key, Palette, TestTube, Plus, X, Tag } from 'lucide-react';
...
export const SettingsDialog = ({
  ...
  const handleAddIntent = () => {
    if (newIntent.trim() && !customIntents.includes(newIntent.trim())) {
      addCustomIntent(newIntent.trim());
      setNewIntent('');
      toast({
        title: "Intent added",
        description: `"${newIntent.trim()}" has been added to your intents.`
      });
    }
  };
  ...
  const handleRemoveIntent = (intent: string) => {
    ...
    toast({
      ...
      description: `"${intent}" has been removed from your intents.`
    });
  };
          ...
          <TabsContent value="intents" className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={handleAddIntent} disabled={!newIntent.trim()}>
            ...
            <div className="space-y-2">
              ...
              {customIntents.length === 0 ? (
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  No custom intents added yet. Add some above!
                </p>
              ) : (
            ...
            <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Custom intents will be available when editing rows. The default intent is empty.
              </p>
            </div>
          </TabsContent>
